...
* 您必須在 Linux、Windows 或 AIX 主機上安裝 Java 17（Oracle Java、OpenJDK 或 SAP JDK，適用於 SnapCenter 6.2.1 及更新版本）或 Java 11（適用於 SnapCenter 6.2 及更早版本）。
+
...
+
link:https://www.oracle.com/java/technologies/downloads/#java17["下載適用於 Windows 的 Java"]
...
* 您必須在 Linux 主機上安裝 Java 17（Oracle Java、OpenJDK 或 SAP JDK，適用於 SnapCenter 6.2.1 及更高版本）或 Java 11（適用於 SnapCenter 6.2 及更早版本）。
+
如果您的 SnapCenter 伺服器主機使用的是 Windows Server 2019 或 Windows Server 2016，則必須為 SnapCenter 6.2.1 及更高版本安裝 Java 17（Oracle Java、OpenJDK 或 SAP JDK），或為 SnapCenter 6.2 及更早版本安裝 Java 11。

+
link:https://www.oracle.com/java/technologies/downloads/#java17["下載適用於 Linux 的 Java"]
...
必要的軟體套件
 a| 
* Java 17（適用於 SnapCenter 6.2.1 及更高版本）、IBM Java 或 Java 11（適用於 SnapCenter 6.2 及更早版本）、IBM Java
