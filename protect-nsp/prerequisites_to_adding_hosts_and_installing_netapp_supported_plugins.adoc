...
* 對於 SnapCenter 6.2.1 及更高版本，您必須安裝 Java 17（Oracle Java 或 OpenJDK）或
* 適用於 Linux、Windows 或 AIX 主機上 SnapCenter 6.2 及更早版本的 Java 11。
+
...
+
如果您的 SnapCenter Server 主機使用的是 Windows Server 2019 或 Windows Server 2016，則必須為 SnapCenter 6.2.1 及更高版本安裝 Java 17（Oracle Java 或 OpenJDK），或為 SnapCenter 6.2 及更早版本安裝 Java 11。
...
必要的軟體套件
 a| 
* Java 17 適用於 SnapCenter 6.2.1 及更高版本、IBM Java 或
* Java 11 適用於 SnapCenter 6.2 及更早版本、IBM Java
