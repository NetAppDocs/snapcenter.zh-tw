...
* 您必須在 Linux、Windows 或 AIX 主機上安裝 Java 17、Java 11（僅適用於 SnapCenter 6.2）。
+
...
+
如果您的 SnapCenter 伺服器主機使用的是 Windows Server 2019 或 Windows Server 2016，則必須安裝 Java 17、Java 11（僅適用於 SnapCenter 6.2）。
...
必要的軟體套件
 a| 
Java 17、Java 11（僅限 SnapCenter 6.2）、IBM Java
