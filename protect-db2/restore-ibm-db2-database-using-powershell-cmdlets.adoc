...
summary: 還原 IBM DB2 備份包括起始與 SnapCenter 伺服器的連線工作階段、列出備份和擷取備份資訊、以及還原備份。 
---
= 使用 PowerShell Cmdlet 還原 IBM DB2 資料庫
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
還原 IBM DB2 備份包括起始與 SnapCenter 伺服器的連線工作階段、列出備份和擷取備份資訊、以及還原備份。
