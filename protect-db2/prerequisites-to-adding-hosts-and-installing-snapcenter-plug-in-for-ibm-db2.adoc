...
* 您必須為root或非root使用者啟用密碼型SSH連線。
* 您必須在 Linux 或 AIX 主機上安裝 Java 17（Oracle Java、OpenJDK 或 SAP JDK，適用於 SnapCenter 6.2.1 及更新版本）或 Java 11（適用於 SnapCenter 6.2 及更早版本）。
+
link:https://www.oracle.com/java/technologies/downloads/#java17["下載適用於 Linux 的 Java"^]

+
link:https://developer.ibm.com/languages/java/semeru-runtimes/downloads/?license=IBM["下載適用於 AIX 的 Java"^]
