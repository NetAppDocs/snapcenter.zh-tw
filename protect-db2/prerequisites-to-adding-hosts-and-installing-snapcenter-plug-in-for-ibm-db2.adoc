...
+
link:https://www.oracle.com/java/technologies/javase/jdk11-archive-downloads.html["下載適用於 Windows 的 JAVA"^]
...
+
link:https://www.oracle.com/java/technologies/javase/jdk11-archive-downloads.html["下載適用於 Linux 的 JAVA"^]
