...
有關受支援版本的最新信息，請參閱 https://imt.netapp.com/imt/imt.jsp?components=180321;&solution=1257&isHWU&src=IMT["NetApp 互通性對照表工具"^]。
 a| 
* Red Hat Enterprise Linux （ RHEL ） 8 和 9
* SUSE Linux Enterprise Server （ SLES ） 15.


有關受支援版本的最新信息，請參閱 https://imt.netapp.com/imt/imt.jsp?components=180320;&solution=1257&isHWU&src=IMT["NetApp 互通性對照表工具"^]。
