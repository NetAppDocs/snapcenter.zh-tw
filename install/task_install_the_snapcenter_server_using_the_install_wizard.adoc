...
您可以使用 PowerShell cmdlet 執行一些安裝和設定步驟（選用）。您應該使用 PowerShell 7.4.13 或更高版本。
...
** .NET擴充性4.5
** 應用程式初始化
** ASP.NET Core 10.0.7 Hosting Bundle（或更高版本）請參閱 link:https://library.netapp.com/ecm/ecm_download_file/ECMLP3359467["SnapCenter 軟體發行說明"^] 以取得適用於您特定 SnapCenter 版本的最新合格 ASP.NET Core 版本。
** 伺服器端隨附
** WebSocket傳輸協定
...
+
** TCP啟動
** HTTP Activation 請參閱 link:https://library.netapp.com/ecm/ecm_download_file/ECMLP3359467["SnapCenter 軟體發行說明"^]，以取得適用於您特定 SnapCenter 版本的最新合格 ASP.NET Core 版本。
