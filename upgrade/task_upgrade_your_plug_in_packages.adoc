...
* 確保在 Windows 插件主機上安裝了 ASP.NET Core Runtime 8.0.24（以及所有後續的 8.0.x 修補程式）託管包和 PowerShell 7.4.13 或更高版本。
* 確保在 Windows 和 Linux 外掛主機上安裝了 Java 17（Oracle Java 或 OpenJDK）（適用於 SnapCenter 6.2.1 及更高版本）或 Java 11（適用於 SnapCenter 6.2 及更早版本）。
