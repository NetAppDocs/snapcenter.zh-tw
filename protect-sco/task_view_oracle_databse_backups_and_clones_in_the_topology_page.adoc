...
或者、您也可以參閱 https://library.netapp.com/ecm/ecm_download_file/ECMLP3337666["《軟件命令參考指南》SnapCenter"^] 或 https://docs.netapp.com/us-en/snapcenter-cmdlets/index.html["《軟件指令程式參考指南》SnapCenter"^]。
