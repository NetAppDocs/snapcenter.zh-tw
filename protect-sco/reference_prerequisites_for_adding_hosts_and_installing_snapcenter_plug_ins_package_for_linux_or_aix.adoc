...
* 您必須安裝 Java 17 （適用於 SnapCenter 6.2.1 及更高版本）或
* 在您的 Linux 或 AIX 主機上安裝 Java 11（適用於 SnapCenter 6.2 及更早版本）。
+
...
必要的軟體套件
 a| 
* Java 17（Oracle 或 OpenJDK）適用於 SnapCenter 6.2.1 及更高版本或
* Java 11 適用於 SnapCenter 6.2 及更早版本
...
必要的軟體套件
 a| 
* IBM Java 17 for SnapCenter 6.2.1 及更高版本或
* IBM Java 11 for SnapCenter 6.2 及更早版本
