...
* 您必須在 Linux 或 AIX 主機上安裝 Java 17、Java 11（僅適用於 SnapCenter 6.2）。
+
...
NOTE: 請確保您在 Linux 主機上僅安裝了經過認證的 Java 17、Java 11（僅適用於 SnapCenter 6.2）版本。
...
必要的軟體套件
 a| 
Java 17（Oracle 或 OpenJDK）、Java 11（僅適用於 SnapCenter 6.2）
...
必要的軟體套件
 a| 
IBM Java 17、IBM Java 11（僅限 SnapCenter 6.2）
