...
* 如果資料庫位於VMware RDM LUN上、您必須部署SnapCenter VMware vSphere的VMware vCenter外掛程式、並使用SnapCenter VMware vCenter登錄外掛程式。。 https://["VMware vSphere文件的VMware外掛程式SnapCenter"] 有更多資訊。
