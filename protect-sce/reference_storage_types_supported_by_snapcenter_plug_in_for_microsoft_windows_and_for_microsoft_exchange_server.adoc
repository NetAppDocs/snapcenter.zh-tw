...
---
= SnapCenter Microsoft Exchange Server 外掛程式支援的儲存類型
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Windows Server 上提供SnapCenter設定和資料保護支援。有關受支援版本的最新信息，請參閱 https://imt.netapp.com/imt/imt.jsp?components=180321;180339;180327;&solution=1257&isHWU&src=IMT["NetApp 互通性對照表工具"^]。
