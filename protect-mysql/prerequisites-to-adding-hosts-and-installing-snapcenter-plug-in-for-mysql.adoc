...
* 您必須在主機上安裝 Java 17（Oracle Java、OpenJDK 或 SAP JDK，適用於 SnapCenter 6.2.1 及更新版本）或 Java 11（適用於 SnapCenter 6.2 及更早版本）。
+
...
* 如果您使用的是低於 8.0 版本的 MySQL，則需要手動安裝並啟用 MySQLX 外掛程式。 MySQLX 外掛程式在 MySQL 8.0 或更高版本中預設安裝並啟用。
...
* 您必須在 Windows 主機上安裝 Java 17（Oracle Java、OpenJDK 或 SAP JDK，適用於 SnapCenter 6.2.1 及更新版本）或 Java 11（適用於 SnapCenter 6.2 及更早版本）。
+
link:https://www.oracle.com/java/technologies/downloads/#java17["下載適用於所有作業系統的 Java"]
