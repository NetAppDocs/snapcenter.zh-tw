...
若要使用 SnapCenter Plug-in for VMware vSphere 設定 CA 憑證，請參閱 https://kb.netapp.com/data-mgmt/SnapCenter/SC_KBs/How_to_create_and_or_import_an_SSL_certificate_to_SnapCenter_Plug-in_for_VMware_vSphere["建立或匯入SSL憑證"^]。
