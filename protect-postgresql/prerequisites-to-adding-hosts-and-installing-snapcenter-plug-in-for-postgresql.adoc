...
* 您的主機上必須安裝 Java 17（適用於 SnapCenter 6.2.1 及更新版本）或 Java 11（適用於 SnapCenter 6.2 及更早版本）。
+
...
* 您的 Windows 主機上必須安裝 Java 17（適用於 SnapCenter 6.2.1 及更新版本）或 Java 11（適用於 SnapCenter 6.2 及更早版本）。
+
